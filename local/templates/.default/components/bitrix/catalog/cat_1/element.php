...
<?
    ...
    <?// компонент для отображения главного слайдера детальной страницы.?>
    <div class="catalog-slider">
        <?$APPLICATION->IncludeComponent(
            "bitrix:catalog.section",
            "slider_element_section",               //  отдельный шаблон + result_modifier.php
            array(
                ...
                "PRICE_CODE" => array("PRICE_ROZN"                  //  добавил валюту для отображения цены на странице.
                ),
                "PRICE_VAT_INCLUDE" => "Y",
                ...
                "RCM_TYPE" => "personal",
                "SECTION_CODE" => $arResult['VARIABLES']['SECTION_CODE'],    // установил значение используемого раздела. чтобы получить в items элементы активного раздела.
