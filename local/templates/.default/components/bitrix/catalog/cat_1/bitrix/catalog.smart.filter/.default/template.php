...
?>
        ...
        <div class="filter-modules">
                ...
                <div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?>">
                        <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
                                ...
                                <div class="filter-module">       <!-- список категорий вначале фильтра -->
                                    <?
    ...
    <!--                                        <div class="filter-module">-->
                                                ...
                                                <div class="filter-price" data-role="bx_filter_block">
                                                    ...
                                                    <div id="range" class="filter-price-range">
    ...
    <!--                                        </div>-->
                                ...
                                <div class="filter-module">
                                    ...
                                    foreach($arResult["ITEMS"] as $key=>$arItem)
                                    {
                                        ...
                                        <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                                            ...
                                            <div class="filter__label" onclick="smartFilter.hideFilterProps(this)">
                                                                ...
                                                                <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
                                                                        <span class="bx-filter-input-checkbox">
                                                                            <input
                                                                                ...
                                                                                onclick="smartFilter.click(this)"
                                                                            />
                                                                            <span class="check" title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?><?
                                                                                if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                                                    ?>&nbsp;(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
                                                                                endif;?></span>
                                                                        </span>
                                ...
                                <!--  окошко с результатом фильтра -->
                                <div class="filter-results">
                                    <div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
                                        <?echo GetMessage("CT_BCSF_FILTER_COUNT", array("#ELEMENT_COUNT#" => '<span id="modef_num">'.intval($arResult["ELEMENT_COUNT"]).'</span>'));?>
                                        <span class="arrow"></span>
                                        <br/>
                                        <a class="filter-results__link" href="<?echo $arResult["FILTER_URL"]?>" target=""><?echo GetMessage("CT_BCSF_FILTER_SHOW")?></a>
                                    </div>
                                </div>
